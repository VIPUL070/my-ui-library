...
const GeminiScrollEffect = () => {
  ...
  return (
    <div
      className="h-[400vh] flex bg-black w-full dark:border dark:border-white/10 rounded-md relative pt-40 overflow-clip"
      ref={ref}
    >
      <SvgPallete
        pathLength={[
  ...
  return (
    <div className={cn("sticky top-0", className)}>
      ...
      <svg
        ...
        className="md:-top-40 w-full sticky top-0"
      >
        <motion.path
...
export default GeminiScrollEffect;
